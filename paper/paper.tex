...
\caption{Business cycles and turning points}\label{fig:cyl_tp}
\end{figure}
...
\midrule
 & Duration (Q) & 8.83 & 4.17 & 13.00\\
\cmidrule{2-5}
\multirow{-2}{*}{\raggedright\arraybackslash CPI} & Amplitude (pp.) & -1.05 & 1.19 & \\
\cmidrule{1-5}
 & Duration (Q) & 6.50 & 6.83 & 13.33\\
\cmidrule{2-5}
\multirow{-2}{*}{\raggedright\arraybackslash Credit} & Amplitude (\%) & -1.24 & 0.87 & \\
\cmidrule{1-5}
 & Duration (Q) & 9.20 & 8.50 & 17.70\\
\cmidrule{2-5}
\multirow{-2}{*}{\raggedright\arraybackslash Credit/GDP} & Amplitude (pp.) & -1.49 & 1.25 & \\
\cmidrule{1-5}
 & Duration (Q) & 9.50 & 9.25 & 18.75\\
\cmidrule{2-5}
\multirow{-2}{*}{\raggedright\arraybackslash GDP} & Amplitude (\%) & -1.44 & 1.48 & \\
\cmidrule{1-5}
 & Duration (Q) & 5.71 & 4.62 & 10.34\\
\cmidrule{2-5}
\multirow{-2}{*}{\raggedright\arraybackslash House} & Amplitude (\%) & -1.10 & 1.58 & \\
\cmidrule{1-5}
 & Duration (Q) & 6.60 & 8.00 & 14.60\\
\cmidrule{2-5}
\multirow{-2}{*}{\raggedright\arraybackslash R007} & Amplitude (pp.) & -1.38 & 2.06 & \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
CPI & 1.00 & 0.40 & 0.44 & 0.61 & 0.60 & 0.50\\
Credit & 0.40 & 1.00 & 0.73 & 0.56 & 0.55 & 0.55\\
Credit/GDP & 0.44 & 0.73 & 1.00 & 0.29 & 0.42 & 0.51\\
GDP & 0.61 & 0.56 & 0.29 & 1.00 & 0.56 & 0.58\\
House & 0.60 & 0.55 & 0.42 & 0.56 & 1.00 & 0.40\\
\addlinespace
R007 & 0.50 & 0.55 & 0.51 & 0.58 & 0.40 & 1.00\\
\bottomrule
\end{tabular}
\end{table}
